namespace IniFileNet.Test
{
	...
	public static class IniValueAcceptorDictionaryBuilderTests
	{
		...
		public static void AddMethods()
		{
			...
			IniValueAcceptorOnlyFirst<short> onlyfirst2 = builder.OnlyFirst("onlyfirst2", Parse.Int16);
			IniValueAcceptorOnlyLast onlylast1 = builder.OnlyLast("onlylast1");
			IniValueAcceptorOnlyLast<int> onlylast2 = builder.OnlyLast("onlylast2", Parse.Int32);
			IniValueAcceptorSingle single1 = builder.Single("single1");
			IniValueAcceptorSingle<long> single2 = builder.Single("single2", Parse.Int64);
			IniValueAcceptorMany many1 = builder.Many("many1");
			IniValueAcceptorMany<double, List<double>> many2 = builder.Many<double, List<double>>("many2", Parse.Double);
